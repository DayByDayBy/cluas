...
from src.characters.config import DEFAULT_PROVIDER_CONFIG_MAGPIE
...
class Magpie(Character):
    ...
    def __init__(self, provider_config: Optional[Dict] = None, location: Optional[str] = None):
        ...
        if provider_config is None:
            provider_config = DEFAULT_PROVIDER_CONFIG_MAGPIE.copy()
    ...
    def _get_tool_definitions(self) -> List[Dict]:
        ...
        return get_tools_for_character(["explore_web", "get_trends", "explore_trend_angles", "check_local_weather"])
