...
from src.characters.config import DEFAULT_PROVIDER_CONFIG_RAVEN
...
class Raven(Character):
    ...
    def __init__(self, provider_config: Optional[Dict] = None, location: Optional[str] = None):
        ...
        if provider_config is None:
            provider_config = DEFAULT_PROVIDER_CONFIG_RAVEN.copy()
    ...
    def _get_tool_definitions(self) -> List[Dict]:
        ...
        return get_tools_for_character(["verify_news", "explore_web", "get_trends", "check_local_weather"])
